...
CHECKPOINT_PATH = "Try2/checkpoints/best_gin_lt.pt"

RESULTS_PATH = "Try2/results/gin_lt_results.txt"

PREDICTIONS_PATH = "Try2/results/gin_lt_predictions.csv"
