...
CHECKPOINT_PATH = Path(
    "Try2/checkpoints/best_gcn_ic.pt"
)

RESULTS_PATH = Path(
    "Try2/results/gcn_ic_results.txt"
)
...
print("=" * 60)
print("GCN-IC Publication Baseline")
print("=" * 60)
...
print(
    "IC Min Spread    :",
    f"{valid_ic.min().item():.4f}"
)

print(
    "IC Mean Spread   :",
    f"{valid_ic.mean().item():.4f}"
)

print(
    "IC Max Spread    :",
    f"{valid_ic.max().item():.4f}"
)
...
"""
Vanilla GCN for IC Influence Estimation.
