...
CHECKPOINT_PATH = Path(
    "Try2/checkpoints/best_gat_ic.pt"
)

RESULTS_PATH = Path(
    "Try2/results/gat_ic_results.txt"
)

PREDICTION_PATH = Path(
    "Try2/results/gat_ic_predictions.csv"
)
...
print("=" * 60)
print("GAT-IC Publication Benchmark")
print("=" * 60)
